...
{
	public class _BlogDetailClougTagByBlogComponentPartial:ViewComponent
	{
		private readonly IHttpClientFactory _httpClientFactory;

		public _BlogDetailClougTagByBlogComponentPartial(IHttpClientFactory httpClientFactory)
		{
